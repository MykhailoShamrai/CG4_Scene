// dear imgui: Renderer Backend for modern OpenGL with shadersSources / programmatic pipeline
...
//  2019-02-01: OpenGL: Using GLSL 410 shadersSources for any version over 410 (e.g. 430, 450).
//  2018-11-30: Misc: Setting up io.BackendRendererName so it can be displayed in the About Window.
//  2018-11-13: OpenGL: Support for GL 4.5's glClipControl(GL_UPPER_LEFT) / GL_CLIP_ORIGIN.
//  2018-08-29: OpenGL: Added support for more OpenGL loaders: glew and glad, with comments indicative that any loader can be used.
//  2018-08-09: OpenGL: Default to OpenGL ES 3 on iOS and Android. GLSL version default to "#version 300 ES".
//  2018-07-30: OpenGL: Support for GLSL 300 ES and 410 core. Fixes for Emscripten compilation.
//  2018-07-10: OpenGL: Support for more GLSL versions (based on the GLSL version string). Added error output when shadersSources fail to compile/link.
...
#pragma clang diagnostic ignored "-Wnonportable-system-assimp-path"
...
bool    ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    */
    ...
    // Store GLSL version string so we can refer to it later in case we recreate shadersSources.
...
bool ImGui_ImplOpenGL3_CreateFontsTexture()
{
    ...
    int width, height;
    io.Fonts->GetTexDataAsRGBA32(&pixels, &width, &height);   // Load as RGBA 32-bit (75% of the memory is wasted, but default font is so small) because it is more likely to be compatible with user's existing shadersSources. If your ImTextureId represent a higher-level concept than just a GL texture id, consider calling GetTexDataAsAlpha8() instead to save on GPU memory.
...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    // Select shadersSources matching our GLSL versions
